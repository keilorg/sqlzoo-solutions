...
*/
SELECT name, gdp/population gdp_per_capita
FROM world
WHERE population > 200000000;
...
*/
SELECT name, population/1000000 population_mil
FROM world
...
*/
SELECT name, ROUND(population/1000000, 2) population_mil, ROUND(gdp/1000000000, 2) gdp_bil
FROM world
WHERE continent = 'South America';
...
*/
SELECT name, ROUND(gdp/population, -3) gdp_per_capita
FROM world
